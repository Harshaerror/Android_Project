...
public class TestAdapter {
    ...
    private com.example.farmerapp.DatahelperActivity mDbHelper;

    public TestAdapter(Context context) {
        this.mContext = context;
        mDbHelper = new com.example.farmerapp.DatahelperActivity(mContext);
...
/***********Insert User Query************/
    ...
    public Cursor getUserdetailsss(String userid) {
        String q = "Select * from User where MedicalID='" + userid + "'";
    ...
    public Cursor getUserid(String userid) {
        String q = "Select * from User where Mobile='" + userid + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public long InsertAdvertiser(String sname, String scomapny, String smobile, String semail, String spass) {
        long i;
        ContentValues values = new ContentValues();
        values.put("Store", sname);
        values.put("Company", scomapny);
        values.put("Mobile", smobile);
        values.put("Email", semail);
        values.put("Password", spass);

        i = mDb.insert("Advertiser", null, values);
        return i;
    }

    public int checkAaddvertiserLogin(String smobile, String spassword) {
        int i;
        String sql = "select count(*) from Advertiser where Mobile='" + smobile + "' and Password='" + spassword+ "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
    ...
    public Cursor getAdvertisername(String name) {
        String q = "Select * from Advertiser where Mobile='" + name + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public long InsertDelivery(String aname, String aaddress, String amobile, String aemail, String apass) {

        long i;
        ContentValues values = new ContentValues();
        values.put("Name", aname);
        values.put("Address", aaddress);
        values.put("Mobile", amobile);
        values.put("Email", aemail);
        values.put("Password", apass);

        i = mDb.insert("Delivery", null, values);
        return i;
    }


    public Cursor getDboyname(String smobile) {
        String q = "Select * from Delivery where Mobile='" + smobile + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public int checkAffilatorLogin(String smobile, String spassword) {
        int i;
        String sql = "select count(*) from Affilatore where Mobile='" + smobile + "' and Password='" + spassword+ "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
    ...
    public Cursor getdelivery(String smobile) {
        String q = "Select * from Delivery where Mobile='" + smobile + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public Cursor getDeliveryboydetaisl(String smobile) {
        String q = "Select * from Delivery where Mobile='" + smobile + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }
    public Cursor selectDelivery() {
        String sql="select * from Delivery";
        Cursor c=mDb.rawQuery(sql, null);
        return c;
    }

    public int checkDeliveryLogin(String smobile, String spassword) {
        int i;
        String sql = "select count(*) from Delivery where Mobile='" + smobile + "' and Password='" + spassword+ "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
    ...
    public long InsertAdmin(String aname, String aaddress, String amobile, String aemail, String apass) {
        long i;
        ContentValues values = new ContentValues();
        values.put("Name", aname);
        values.put("Address", aaddress);
        ...
        i = mDb.insert("Admin", null, values);
        return i;
    }

    public Cursor selectAdmin() {
        String sql="select * from Admin";
        Cursor c=mDb.rawQuery(sql, null);
        return c;
    }

    public Cursor getadmin(String mobilenum) {
        String q = "Select * from Admin where Mobile='" + mobilenum + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public int checkAdminLogin(String smobile, String spassword) {
        int i;
        String sql = "select count(*) from Admin where Mobile='" + smobile + "' and Password='" + spassword+ "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
    ...
    public long AddDelivery(String sdid, String sdname, String sdtype,String sddate, String sdsize, String sdqty,
                            String sdlocation, String sdshipping, String sddistance) {

        long i;
        ContentValues values = new ContentValues();
        values.put("D_Id", sdid);
        values.put("D_Name", sdname);
        values.put("D_Type", sdtype);
        values.put("D_Date", sddate);
        values.put("D_Size", sdsize);
        values.put("D_Qty", sdqty);
        values.put("D_Location", sdlocation);
        values.put("D_Shipping", sdshipping);
        values.put("D_Distance", sddistance);


        i = mDb.insert("DeliveryItem", null, values);
        return i;
    }

    public Cursor selectDelivryitem() {
        String sql="select * from DeliveryItem";
        Cursor c=mDb.rawQuery(sql, null);
        return c;
    }

    public Cursor deliveryincrementid() {
        String sql = "select max(D_Id) from DeliveryItem";
        Cursor c = mDb.rawQuery(sql, null);
        return c;
    }

    public Cursor getAlldeliverydetails(String compid) {
        String q = "Select * from DeliveryItem where D_Id='" + compid + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public long RequestforDelivery(String sdid, String sdname, String sdtype, String sddate,
                                   String sdsize, String sdqty, String sdlocation, String sdshipping,
                                   String sddistance,String smob, String sdamount) {
        ...
        values.put("D_Shipping", sdshipping);
        values.put("D_Distance", sddistance);
        values.put("D_Mobile", smob);
        values.put("D_Amount",sdamount);


        i = mDb.insert("RequestDelivery", null, values);
        return i;
    }

    public Cursor selectDelivryRequest() {
        String sql="select * from RequestDelivery";
        Cursor c=mDb.rawQuery(sql, null);
        return c;
    }

    public Cursor getAlldeliveryaccepted(String compid) {
        String q = "Select * from RequestDelivery where D_Id='" + compid + "'";
        Cursor c = mDb.rawQuery(q, null);
        return c;
    }

    public Cursor selectDelivryRequestincrement() {
        String sql = "select max(D_Id) from RequestDelivery";
        Cursor c = mDb.rawQuery(sql, null);
        return c;
    }
